...
found:
	if ((port->disc_addr.trtype == NVMF_TRTYPE_TCP || port->disc_addr.trtype == NVMF_TRTYPE_MPTCP) &&
...
found:
	...
	else if (port->disc_addr.trtype == NVMF_TRTYPE_TCP || port->disc_addr.trtype == NVMF_TRTYPE_MPTCP)
